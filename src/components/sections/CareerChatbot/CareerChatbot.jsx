...
import { QUICK_STATS, SKILLS_DATA } from '../../../constants/skills';
...
function buildSystemPrompt() {
  ...
  return `You are an AI career assistant representing Hajun Yun, a Full-Stack Developer & AI Engineer.
...
RULES:
1. Answer as Hajun Yun's AI career representative — first-person perspective.
...
6. Always maintain a helpful and enthusiastic tone about Hajun Yun's work.
...
function ChatMessage({ message, currentTheme }) {
  ...
  return (
    ...
    >
      {!isUser && (
        <div className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${currentTheme === 'neon'
...
function TypingIndicator({ currentTheme }) {
  return (
    <div className="flex gap-3">
      ...
      <div className={`px-4 py-3 rounded-2xl ${currentTheme === 'minimal'
        ? 'bg-gray-100'
        : currentTheme === 'corporate'
    ...
    return (
      ...
      >
        <div className="flex flex-col h-full relative">
          <div className={`p-6 border-b backdrop-blur-sm ${currentTheme === 'minimal'
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black/20 backdrop-blur-sm">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`inline-flex items-center gap-3 px-8 py-4 rounded-xl font-semibold text-white transition-all duration-300 shadow-xl ${currentTheme === 'neon'
  ...
  return (
    ...
    >
      <div className="flex flex-col h-full">
        <div className={`p-4 border-b backdrop-blur-sm flex items-center justify-between ${currentTheme === 'minimal'
          ? 'border-gray-200 bg-white/50'
          : currentTheme === 'neon'
            ? 'border-cyan-800/50 bg-cyan-900/10'
            : currentTheme === 'corporate'
          ...
          <div className="flex items-center gap-3">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-base ${currentTheme === 'neon'
              ? 'bg-cyan-500/20'
              : currentTheme === 'minimal'
                ? 'bg-gray-200'
                : currentTheme === 'corporate'
          ...
          <div className="flex items-center gap-2">
            {messages.length > 0 && (
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className={`text-xs px-3 py-1.5 rounded-lg font-semibold transition-colors ${currentTheme === 'neon'
        ...
        {error && (
          <motion.div
            ...
            className={`mx-4 mt-2 text-center p-3 rounded-lg text-sm ${currentTheme === 'minimal'
          ...
          {messages.length === 0 && !isLoading && (
            <div className="flex flex-col items-center justify-center h-full text-center opacity-60">
              ...
              <p className={`text-sm ${themeStyles.text}`}>
                Ask me anything about Hajun Yun&apos;s career!
              </p>
        ...
        <form
          ...
          className={`p-4 border-t ${currentTheme === 'minimal'
            ? 'border-gray-200 bg-white/50'
            : currentTheme === 'neon'
              ? 'border-cyan-800/50 bg-cyan-900/10'
              : currentTheme === 'corporate'
        ...
        >
          <div className="flex gap-2">
            <input
              ...
              disabled={isLoading}
              className={`flex-1 px-4 py-2.5 rounded-xl text-sm outline-none transition-colors ${currentTheme === 'neon'
            ...
            <motion.button
              ...
              className={`px-4 py-2.5 rounded-xl font-medium text-white transition-all duration-200 ${isLoading || !inputValue.trim()
                ? 'cursor-not-allowed'
                : currentTheme === 'neon'
